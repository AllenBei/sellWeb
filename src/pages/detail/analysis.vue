  ...
  <div class="sales-board">
    <div class="sales-board-intro">
      ...
      <p>是指在获得网站访问量基本数据的情况下对有关数据进行统计、分析，从中发现用户访问网站的规律，
        并将这些规律与网络营销策略等相结合，从而发现目前网络营销活动中可能存在的问题，并为进一步修正或重新制定网络营销
        策略提供依据。当然这样的定义是站在网络营销管理的角度来考虑的</p>
    </div>
    ...
    methods:{
      getPrice () {
        ...
        let reqParams = {
          ...
          amount: this.buyNum *((this.period.value+1) * 80)* buyVersionsArray.length
        }
